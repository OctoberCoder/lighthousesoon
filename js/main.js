...
(function ($) {
    ...
    var ssAjaxChimp = function () {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Submitting...',
            0: '<i class="fas fa-check"></i> We have sent you a confirmation email. Please check your inbox or spam folder',
            1: '<i class="fas fa-exclamation-triangle"></i> Please enter a value. You must enter a valid e-mail address.',
            2: '<i class="fas fa-exclamation-triangle"></i> E-mail address is not valid. An email address must contain a single @',
